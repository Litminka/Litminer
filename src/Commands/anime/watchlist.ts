...
import PaginatedEmbed, { PaginatedEmbedType } from "../../embeds/paginated/PaginatedEmbed";
...
export default {
    ...
    execute: async ({ client, interaction }) => {
        ...
        const paginatedEmbed = new WatchlistEmbed(interaction.user.id);
        ...
        const response = await interaction.reply({
            ephemeral: true,
            embeds: paginatedEmbed.getEmbeds(),
            components: [paginatedEmbed.getActionRow()],
        ...
        //         embeds: LitminkaEmbeds.ShowWatchlist(list),
        //         components: [row]
        //     });
        // });
